        ...
        >
          <div className="toast-card">
            ...
            <div className="toast-text-container">
              ...
              <p className="toast-sub-text">{subMessage}</p>
            </div>

            <button onClick={hideToast} className="p-1 hover:bg-slate-100 rounded-full transition-colors">
              <X size={18} className="toast-cross-icon" />
            </button>
          </div>
        </motion.div>
      )}
